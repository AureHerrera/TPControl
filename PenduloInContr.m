...
h=0.0001;tiempo=(5/h);p_pp=0;tita_pp=0; t=0:h:tiempo*h;
...
figure(2);hold on;
subplot(2,1,1);plot(alfa,omega,color);grid on;xlabel('Ángulo');ylabel('Velocidad angular');hold on;
subplot(2,1,2);plot(p,p_p,color);grid on;xlabel('Posicion carro');ylabel('Velocidad carro');hold on;